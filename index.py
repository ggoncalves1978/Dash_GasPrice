...
df_main.drop(['UNIDADE DE MEDIDA', 'COEF DE VARIAÇÃO REVENDA', 'COEF DE VARIAÇÃO DISTRIBUIÇÃO',
              'NÚMERO DE POSTOS PESQUISADOS', 'DATA INICIAL', 'DATA FINAL',
               'PREÇO MÁXIMO DISTRIBUIÇÃO', 'DESVIO PADRÃO REVENDA', 'DESVIO PADRÃO DISTRIBUIÇÃO', 'MARGEM MÉDIA REVENDA',
                 'PREÇO MÍNIMO REVENDA', 'PREÇO MÁXIMO REVENDA', 'PREÇO MÍNIMO DISTRIBUIÇÃO', 'PRODUTO', 'PREÇO MÉDIO DISTRIBUIÇÃO'],
                 inplace=True, axis=1)
...
app.layout = dbc.Container(children=[
    ...
    ], className='main_row g-2 my-auto', style={'margin-top': '7px'}), # Ajusta o espaçamento entre os graficos
    ...
    ], justify='center', className='main_row g-2 my-auto'), # Ajusta o espaçamento entre os graficos
    ...
    ], className='main_row g-2 my-auto') # Ajusta o espaçamento entre os graficos
